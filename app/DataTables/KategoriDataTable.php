    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($id) {
                return '<a class="btn btn-primary" href="' . route('updatekategori', ['id' => $id->kategori_id]) . '">Ubah</a> '.
                    '<a class="btn btn-danger" href="' . route('deletekategori', ['id' => $id->kategori_id]) . '">Hapus</a>';
            })
            ->setRowId('id');
    }
