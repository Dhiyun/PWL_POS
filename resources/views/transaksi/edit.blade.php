    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/transaksi/'.$transaksi->penjualan_id) }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="datetime-local" class="form-control" id="penjualan_tanggal" name="penjualan_tanggal" value="{{ old('penjualan_tanggal', $transaksi->penjualan_tanggal) }}" required>
